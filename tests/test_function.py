...
class StructuredBasis1D(CommonBasis, TestCase):
  ...
  def setUp(self):
    self.checktransforms = transformseq.StructuredTransforms([transformseq.DimAxis(0,4,False)], 0)
...
class StructuredBasis1DPeriodic(CommonBasis, TestCase):
  ...
  def setUp(self):
    self.checktransforms = transformseq.StructuredTransforms([transformseq.DimAxis(0,4,True)], 0)
    index, coords = self.mk_index_coords(1, self.checktransforms)
...
class StructuredBasis2D(CommonBasis, TestCase):
  ...
  def setUp(self):
    self.checktransforms = transformseq.StructuredTransforms([transformseq.DimAxis(0,2,False),transformseq.DimAxis(0,2,False)], 0)
